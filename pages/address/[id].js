        ...
        <div className="details-card">
          <div className="detail-item">
            ...
            <div className="detail-content">
              ...
              <div className="detail-value">{address?.usdBalance} (@ $1.00/tUCC)</div>
            </div>
          </div>
        ...
        <div className="details-card">
          <div className="detail-item">
            ...
            <div className="detail-content">
              ...
              <div className="detail-value">{address?.isContract ? 'Contract' : 'Account'}</div>
            </div>
          </div>
                        ...
                        <tr key={tx.hash}>
                          ...
                          <td>
                            <div className="hash-row">
                              <Link href={`/address/${tx.from}`} className="hash-text">
                                {tx.from === address.address ? "You" : `${tx.from.substring(0, 6)}...${tx.from.substring(tx.from.length - 4)}`}
                              </Link>
                            </div>
                          </td>
                          <td>
                          ...
                          <td>
                            <div className={`amount-value ${tx.to === address.address ? 'amount-in' : 'amount-out'}`}>
                              {tx.to === address.address ? '+' : '-'}{tx.value}
                            </div>
                          </td>
                          <td>
              ...
              <div className="table-container">
                ...
                {address?.isVerified ? (
                  <div className="contract-code">
                    <pre>{address?.contractInfo?.sourceCode || 'Source code not available'}</pre>
                  </div>
                ) : (
                  <div className="detail-item">
                    <div className="detail-icon">
                    ...
                    <div className="detail-content">
                      ...
                      <div className="detail-value">
                        Source code is not available because this contract has not been verified.
                      </div>
                      <div className="detail-value">
                        <Link href="/verify-contract" className="verify-button">
                          Verify Contract
